...
class SessionManager {
    ...
    async loadSession() {
        ...
        try {
            ...
            if (sessionJson !== null) {
                session = await U.fromJSON(this.protocol.transport, sessionJson);
            }
        }
        catch (error) { }
        await this.setSession(session);
